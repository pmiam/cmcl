...
t = 0.20
if Data == 'PBE':
    X_train, X_test, Formulas_train, Formulas_test, Prop_train_latt, Prop_test_latt, Prop_train_gap, Prop_test_gap, Prop_train_form, Prop_test_form, Prop_train_decomp, Prop_test_decomp, Prop_train_eps, Prop_test_eps, Prop_train_fom, Prop_test_fom = train_test_split(X, Formula, PBE_latt, PBE_gap, PBE_form_en, PBE_decomp_en, PBE_eps, PBE_fom, test_size=t)
if Data == 'HSE':
    X_train, X_test, Formulas_train, Formulas_test, Prop_train_latt, Prop_test_latt, Prop_train_gap, Prop_test_gap, Prop_train_form, Prop_test_form, Prop_train_decomp, Prop_test_decomp = train_test_split(X, Formula, HSE_latt, HSE_gap, HSE_form_en, HSE_decomp_en, test_size=t)
...
train_errors_latt = copy.deepcopy(train_errors)
test_errors_latt  = copy.deepcopy(test_errors)
...
if Data == 'PBE':
    ...
    plt.savefig('plot_PBE_NN_models.pdf', dpi=450)
...
if Data == 'HSE':
    ...
    plt.savefig('plot_HSE_NN_models.pdf', dpi=450)
